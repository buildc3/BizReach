...
import type { TemplateInput } from "@/lib/schemas";
...
export function useRenderPitch(templateId: string, leadId: string) {
  return useQuery({
    queryKey: ["pitch-preview", templateId, leadId],
    queryFn: () => api.templates.renderPitch(templateId, leadId),
